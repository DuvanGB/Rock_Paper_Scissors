...
function win(userChoice, computerChoice) {
  ...
  result_p.innerHTML = `${convertToWord(
    userChoice
  )}${smallUserWord} Rompe ${convertToWord(
    computerChoice
  )}${smallComputerWord} .Tu ganas!`;
...
function lose(userChoice, computerChoice) {
  ...
  result_p.innerHTML = `${convertToWord(
    userChoice
  )}${smallUserWord} Pierde ${convertToWord(
    computerChoice
  )}${smallComputerWord} .Perdiste..`;
...
function draw(userChoice, computerChoice) {
  ...
  result_p.innerHTML = `${convertToWord(
    userChoice
  )}${smallUserWord} iguales ${convertToWord(
    computerChoice
  )}${smallComputerWord} .es un empate!`;
